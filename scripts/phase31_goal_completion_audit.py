...
DEFAULT_ORACLE_DIR = Path("outputs/phase30_live_oracle_visuals/mp3d_oracle_visuals_20260622-204418/eval")
...
def main() -> None:
    ...
    parser.add_argument("--out-dir", default="outputs/phase31_goal_audit")
...
def _write_summary_html(out_dir: Path, report: dict) -> None:
    ...
    html = f"""<!doctype html>
<html lang="en">
<head><meta charset="utf-8"><title>Phase 3.1 Goal Completion Audit</title>
<style>
...
<body>
<h1>Phase 3.1 Goal Completion Audit</h1>
